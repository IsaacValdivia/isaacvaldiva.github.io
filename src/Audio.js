...
import { Card, CardImg, CardImgOverlay, Fade, Progress } from "reactstrap";
import { Container, Row, Col, Modal, ModalHeader, ModalBody } from "reactstrap";
import { ListGroup, ListGroupItem } from "reactstrap";
import { GiMinerals, GiViolin, GiSoundWaves, GiConsoleController, GiQuillInk, GiPianoKeys, GiAudioCassette, GiPerspectiveDiceSixFacesRandom } from "react-icons/gi";
...
import { METAL_ITEMS, ORCHESTRAL_ITEMS, ELECTRONIC_ITEMS, CHAMBER_ITEMS, INTERACTIVE_ITEMS, PERFORMANCE_ITEMS, HYBRID_ITEMS, HIP_HOP_ITEMS } from "./VideoData";
...
let TOP_LEFT = <Node title="Orchestral" icon={ORCHESTRA_ICON} videodata={ORCHESTRAL_ITEMS} />;
let TOP_CENTER = <Node title="Interactive" icon={INTERACTIVE_ICON} videodata={INTERACTIVE_ITEMS} special={true} />;
let TOP_RIGHT = <Node title="Metal&Rock" icon={METAL_ICON} videodata={METAL_ITEMS} />;
let MID_LEFT = <Node title="Electronic" icon={ELECTRONIC_ICON} videodata={ELECTRONIC_ITEMS} />;
let MID_RIGHT = <Node title="Chamber" icon={CHAMBER_ICON} videodata={CHAMBER_ITEMS} />;
let BOT_RIGHT = <Node title="Hybrid" icon={HYBRID_OTHER_ICON} videodata={HYBRID_ITEMS} disabled/>;
let BOT_CENTER = <Node title="Performance" icon={PERFORMANCE_ICON} videodata={PERFORMANCE_ITEMS} />;
let BOT_LEFT = <Node title="Hip-Hop" icon={HIP_HOP_ICON} videodata={HIP_HOP_ITEMS} disabled/>;
